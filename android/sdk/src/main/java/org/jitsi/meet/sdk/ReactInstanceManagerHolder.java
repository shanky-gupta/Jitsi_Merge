...
import org.jitsi.meet.Activity_Chat_Window_New;
import org.webrtc.DefaultVideoDecoderFactory;
import org.webrtc.EglBase;

import org.jitsi.meet.Activity_Chat_Window;
...
public class ReactInstanceManagerHolder {
        ...
        List<NativeModule> nativeModules
            = new ArrayList<>(Arrays.<NativeModule>asList(
              ...
              //  new ProximityModule(reactContext),
                new Activity_Chat_Window(reactContext),
                new Activity_Chat_Window_New(reactContext),
   ...
   public static void emitEvent(
     ...
     */
    static void initReactInstanceManager(Application application,Activity activity) {
        if (reactInstanceManager != null) {
            return;
        }
