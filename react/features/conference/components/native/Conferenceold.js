...
import { NativeModules, SafeAreaView, StatusBar, View , NativeEventEmitter,DeviceEventEmitter } from 'react-native';
...
import { toggleTileView , setTileView } from '../../../video-layout';
import {
    FILMSTRIP_SIZE,
    Filmstrip,
    isFilmstripVisible,
...
class Conference extends AbstractConference<Props, *> {
    ...
    constructor(props) {
        ...
        this._selfTileView = this._selfTileView.bind(this);
    ...
    componentDidMount() {
        ...
        this.subscriptionTileView = eventEmitter.addListener(
            'selfTileView', this._selfTileView);
    }
