 ...
 */
class VideoMuteButtonCustom extends AbstractVideoMuteButton<Props, *> {
    ...
    _setVideoMuted(videoMuted: boolean) {
        ...
        AudioMode.videoButtonToggled(true);
    }
...
export default translate(connect(_mapStateToProps)(VideoMuteButtonCustom));
