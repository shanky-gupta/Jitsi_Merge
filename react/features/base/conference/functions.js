...
export function commonUserJoinedHandling(
    ...
    if(NativeModules.OpenMelpAppChat && NativeModules.OpenMelpAppChat.anyuserjoinmeeting) {
        NativeModules.OpenMelpAppChat.anyuserjoinmeeting();
    }
   ...
   NativeModules.NativeCalls.userjoin();
}
...
export function commonUserLeftHandling(
    ...
    if(NativeModules.OpenMelpAppChat && NativeModules.OpenMelpAppChat.anyuserleftmeeting){
     NativeModules.OpenMelpAppChat.anyuserleftmeeting();
    }
