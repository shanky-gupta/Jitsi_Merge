...
function Thumbnail(props: Props) {
    ...
    return (
        <Container
            ...
            <ParticipantView
                avatarSize = { tileView ? ((members < 9)? 190 : AVATAR_SIZE) :  AVATAR_SIZE }
            ...
            { renderDisplayName && <View style = { styles.displayNameContainer }>
            ...
            <View
                ...
                <ConnectionIndicator participantId = { participant.id } connectionState = { props.connectionState } />
            </View>
